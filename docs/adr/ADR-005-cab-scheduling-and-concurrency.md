...
- Status: Proposed historical design — superseded as target by ADR-009
- Date: 2026-08-27

> **Current target:** [ADR-009](./ADR-009-change-authorization-model.md) models CAB
> as one provider-neutral governance decision and separates authorization from
> runtime window eligibility. CAB-as-an-ADO-post-check/deferred-approval is not the
> canonical model. Execution-system locking may remain a technical safety control,
> not business authorization state.
